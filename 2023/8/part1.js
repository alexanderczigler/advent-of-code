...
assert(getInstructions(testInput).join(",") === "0,0,1");
...
assert(getMap(testInput).AAA.join(",") === "BBB,BBB");
assert(getMap(testInput).BBB.join(",") === "AAA,ZZZ");
assert(getMap(testInput).ZZZ.join(",") === "ZZZ,ZZZ");

function navigate(map, instructions, location, target, steps) {
  ...
  return navigate(map, instructions, location, target, steps);
}

const map = getMap(input);
const instructions = getInstructions(input);

const steps = navigate(map, instructions, "AAA", "ZZZ", 0);
